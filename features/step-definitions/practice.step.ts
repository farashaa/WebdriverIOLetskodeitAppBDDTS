...
import alertPage from '../pageobjects/Alert/alert.page';
import checkboxPage from '../pageobjects/Checkbox/checkbox.page';
...
import dropdownPage from '../pageobjects/Drop-down/dropdown.page';
import elementdisplayedPage from '../pageobjects/Element-displayed/elementdisplayed.page';
import enablePage from '../pageobjects/Enable/enable.page';
import iframePage from '../pageobjects/Iframe/iframe.page';
import reloadPage from '../pageobjects/MouseHover/reload.page';
import multipleselectPage from '../pageobjects/Multiple-select/multipleselect.page';
import mycourseheaderPage from '../pageobjects/Mycourse/mycourseheader.page';
import opentabPage from '../pageobjects/OpenTab/opentab.page';
import openwindowPage from '../pageobjects/OpenWindow/openwindow.page';
